...
features:
  - icon: "\U0001F4E6"
    ...
    details: Manage LiteLLM instances, organizations, models, teams, users, customers, credentials, guardrails, and API keys as Kubernetes custom resources. Full GitOps compatibility.
  - icon: "\U0001F504"
