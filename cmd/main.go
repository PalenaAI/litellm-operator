...
import (
	...
	"github.com/PalenaAI/litellm-operator/internal/controller"
...
func main() {
	...
	// Resolve watch namespaces: flag takes precedence, then WATCH_NAMESPACE env var (set by OLM).
	if watchNamespaces == "" {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d0253d00.palena.ai",
	...
	if err := (&controller.LiteLLMBudgetReconciler{
		Client:               mgr.GetClient(),
		Scheme:               mgr.GetScheme(),
		Recorder:             mgr.GetEventRecorderFor("litellmbudget-controller"),
		LiteLLMClientFactory: clientFactory,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LiteLLMBudget")
		os.Exit(1)
	}
